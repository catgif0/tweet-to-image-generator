...
def process_image_task(tweet_text):
    # Generate image from tweet text
    ...
    headers = {"Authorization": "Client-ID e272492b3b91c8c"}  # Replace with your actual Imgur Client ID
...
def test_periodic_task():
    # Test task to generate and upload an image every 2 minutes
